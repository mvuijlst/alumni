...
function Lytebox(bInitialize, aHttp) {
	/*** Language Configuration ***/
		...
		this.label['close']		= 'Sluiten (Esc)';
		this.label['prev'] 		= 'Vorige (\u2190)';	// Previous (left arrow)
		this.label['next'] 		= 'Volgende (\u2192)'; 		// Next (right arrow)
		this.label['play'] 		= 'Afspelen (spatiebalk)';
		this.label['pause'] 	= 'Pauseren (spatiebalk)';
		this.label['print'] 	= 'Afdrukken';
		this.label['image'] 	= 'Foto %1 van %2';		// %1 = active image, %2 = total images
		this.label['page'] 		= 'Foto %1 van %2'; 	// %1 = active page, %2 = total pages
